...
sample_queries = {
    "All Movies": "SELECT * FROM imdb2024 LIMIT 10;",
    "Top Rated Movies": "SELECT Title, Rating FROM imdb2024 ORDER BY Rating DESC LIMIT 10;",
    "Most Voted": "SELECT Title, Votes FROM imdb2024 ORDER BY Votes DESC LIMIT 10;",
    "Action Movies > 8 Rating": "SELECT * FROM imdb2024 WHERE Genre LIKE '%Action%' AND Rating > 8.0;"
}
